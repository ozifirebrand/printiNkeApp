package ozi.app.printApp.mapper;

import ozi.app.printApp.data.dtos.requests.*;
import ozi.app.printApp.data.dtos.responses.*;
import ozi.app.printApp.data.models.*;
